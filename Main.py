...
def mainGame():
    ...
    playerFlapped = False # IT is true onlyy when the UFO is flapping
...
def getRandomPipe():
    """
    Generate posiion of the two pipes (one botom straight and one top rotated) for blitting on the screen
    """
    pipeHeight = GAME_SPRITES['pipe'][0].get_height()
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flying UFO by Nitin')
